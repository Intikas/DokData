...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_deregister_script('jquery');
				wp_register_script('jquery', ASSETS_URL . '/assets/js/jquery-1.12.4.min.js', false, '1.12.4.min', true);

        wp_register_script('js_main', ASSETS_URL . '/assets/js/js.js', array('jquery'), '1.0', true);
...
function register_theme_menus() {
	...
	register_nav_menus(array( 
        ...
        'lang-navigation' => __( 'Language Navigation' ),
        'mob-navigation' => __( 'Mobile Navigation' ),
